...
public class PacketCreator {
    ...
    public static void writeRoleInfoLoginWorld (MaplePacket.PacketStreamLEWriter writer, MapleRole role) {
        ...
        writer.writeShort (role.getBasicInfo().getRemainingAP ());
        writer.writeShort (role.getBasicInfo().getRemainingSP ());
        writer.writeInt (role.getBasicInfo().getExperience ());
        writer.writeShort (role.getBasicInfo().getFame());
        writer.writeInt (role.getBasicInfo().getMapID ());
        writer.writeByte (role.getBasicInfo().getInitSpawnPoint ());
